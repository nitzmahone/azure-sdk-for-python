...
class BuildsOperations(object):
    ...
    def get(
        ...
        """Get the detailed information for a given build.
    ...
    def get_log_link(
        ...
        :rtype:
         ~azure.mgmt.containerregistry.v2017_10_01.models.BuildLogResult or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        log_parameters = None
    ...
    def queue(
        ...
        :type build_request:
         ~azure.mgmt.containerregistry.v2017_10_01.models.QueueBuildRequest
        :param resource_group_name: The name of the resource group to which
         the container registry belongs.
        :type resource_group_name: str
        :param registry_name: The name of the container registry.
