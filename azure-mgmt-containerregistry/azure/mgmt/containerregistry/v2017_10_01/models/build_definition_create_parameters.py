...
class BuildDefinitionCreateParameters(Model):
    ...
    :type source_repository:
     ~azure.mgmt.containerregistry.v2017_10_01.models.SourceRepositoryCreateParameters
    :param steps: The list of build steps in a build definition.
    :type steps:
     list[~azure.mgmt.containerregistry.v2017_10_01.models.BuildStepCreateParameters]
    :param triggers: A collection of custom triggers for this build
     definition.
    :type triggers:
     list[~azure.mgmt.containerregistry.v2017_10_01.models.BuildTriggerParameters]
    ...
    :type status: str or
     ~azure.mgmt.containerregistry.v2017_10_01.models.BuildDefinitionStatus
    :param timeout: Build Time out in seconds.
    :type timeout: int
